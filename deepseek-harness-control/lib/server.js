...
export function createHarnessMcpServer(control, input) {
    const server = new McpServer({ name: 'deepseek-harness-control', version: '0.1.0' }, { instructions: 'Communicate with DeepSeek Harness through its stdio TypeScript SDK. The taskId is the Harness sessionId.' });
